...
description: >
  当需要进行宏观环境分析（PESTLE）时使用。
  用于评估政治、经济、社会、技术、法律、环境6大外部因素对产品战略或市场进入的影响。
  不要用于行业竞争分析（用porters-five-forces）、SWOT分析（用swot-analysis）或市场细分（用market-segments）。
  触发词：PESTLE分析、宏观环境、宏观分析、外部环境、市场环境
