...
name: gtm-motions
description: >
  当需要评估和选择最适合产品的市场推广（GTM）渠道组合时使用。
  用于分析7种GTM动作（入站/出站/付费广告/社区/合作伙伴/ABM/PLG），选择渠道并构建执行计划。
  不要用于制定完整的GTM战略（用gtm-strategy）、增长回路设计（用growth-loops）或定价策略。
  触发词：GTM渠道、市场推广渠道、营销渠道选择、渠道组合、GTM动作
