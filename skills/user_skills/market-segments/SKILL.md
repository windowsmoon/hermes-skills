...
description: >
  当需要识别和分析3-5个潜在客户细分市场时使用。
  用于按人口统计、JTBD、产品匹配度分析细分市场，评估市场机会和目标受众。
  不要用于定义理想客户画像（用ideal-customer-profile）、市场规模估算（用market-sizing）或客户旅程地图（用customer-journey-map）。
  触发词：市场细分、客户细分、细分市场、目标受众、市场分段
