...
description: >
  当需要进行波特五力分析时使用。
  用于评估行业竞争态势（现有竞争者/供应商议价能力/买方议价能力/替代品威胁/新进入者威胁），判断行业吸引力。
  不要用于宏观环境分析（用pestle-analysis）、SWOT分析（用swot-analysis）或单一竞品分析（用competitor-analysis）。
  触发词：波特五力、五力分析、行业竞争、竞争态势、行业分析
