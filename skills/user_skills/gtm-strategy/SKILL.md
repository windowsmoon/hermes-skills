...
name: gtm-strategy
description: >
  当需要制定完整的市场推广战略（GTM策略）时使用。
  用于覆盖营销渠道、信息传达、成功指标和发布时间线的完整GTM计划。
  不要用于单渠道选择（用gtm-motions）、产品定价策略（用pricing-strategy）或仅限产品发布的活动策划。
  触发词：GTM策略、市场推广计划、产品上市策略、发布计划、GTM战略
