---
name: manim-video
description: '当用户需要生成数学/技术动画视频时使用。 基于Manim Community Edition，创建3Blue1Brown风格的教学动画。 不要用于：普通视频剪辑（走video-use）、AI生成视频（走hyperframes）、口播视频。
  触发词：数学动画、技术动画、Manim、教学动画、3Blue1Brown风格
